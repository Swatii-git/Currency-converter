...
dropDowns.forEach((select, index) => {
  ...
  if (index === 1) select.value = "INR";
});

// 3. Flag update karna jab currency change ho
...
// 4. Button par click par rate fetch karo
...
btn.addEventListener("click", async (e) => {
  ...
  try {
    ...
    msg.innerText = `${amount} ${fromCurr} = ${converted} ${toCurr}`;
  } catch (err) {
